...
<head>
        ...
        <div class="real-state"><h2>Real State</h2></div>
            <div class="container-select2">
                ...
                <select id="accionesSelect" onchange="redireccionar()">
                    ...
                    <option value="editar_perfil">Administración</option>
                    <option value="form2">Eliminar</option>
    ...
    <script>
        function redireccionar() {
            ...
            } else if (opcionSeleccionada === "form2") {
        ...
        while ($row = $result->fetch_assoc()) {
            ?>
                <div class="ventana ventana1">
                    ...
                    <button class="comprar"><a href="../VIEW/compraAdmin.php" class="comprar_estilo">Ver Propiedad</a></button>
                </div>
            <?php
        }
    }
