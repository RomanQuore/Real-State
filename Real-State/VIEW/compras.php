...
<body>
    ...
    <div>Informacion de publicación</div>
<form method="POST" action="../CONTROLLER/enviarcomentario.php">
    ...
    <div class="form-group">
        ...
        <input class="form-control" name="nombre" type="text" id= "nombre" placeholder="escribir">
    </div>
    <br>
    <div class="form-group">
        <label for="coment" class="form-label">Comentario:</label>
        <textarea class="form-control" name="coment" cols="30" placeholder="Escribe tu comentario"></textarea>
        </div>
